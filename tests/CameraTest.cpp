...
TEST(PerspectiveCamera, getRay) {
  ...
  auto camera = PerspectiveCamera(fov, image_width, image_height);
  ...
  EXPECT_FLOAT_EQ(cr1.orig().x,  0.f);
  EXPECT_FLOAT_EQ(cr1.orig().y,  0.f);
  EXPECT_FLOAT_EQ(cr1.orig().z,  0.f);
  EXPECT_FLOAT_EQ(cr1.orig().w,  1.f);

  EXPECT_NEAR(cr1.dir().x, -0.811f, float_err);
  EXPECT_NEAR(cr1.dir().y, -0.324f, float_err);
  EXPECT_NEAR(cr1.dir().z, -0.486f, float_err);
  EXPECT_NEAR(cr1.dir().w,  0.f,    float_err);
  ...
  EXPECT_FLOAT_EQ(cr2.orig().x,  0.f);
  EXPECT_FLOAT_EQ(cr2.orig().y,  0.f);
  EXPECT_FLOAT_EQ(cr2.orig().z,  0.f);
  EXPECT_FLOAT_EQ(cr2.orig().w,  1.f);

  EXPECT_NEAR(cr2.dir().x, -0.784f, float_err);
  EXPECT_NEAR(cr2.dir().y,  0.196f, float_err);
  EXPECT_NEAR(cr2.dir().z, -0.588f, float_err);
  EXPECT_NEAR(cr2.dir().w,  0.f,    float_err);
  ...
  EXPECT_FLOAT_EQ(cr3.orig().x,  0.f);
  EXPECT_FLOAT_EQ(cr3.orig().y,  0.f);
  EXPECT_FLOAT_EQ(cr3.orig().z,  0.f);
  EXPECT_FLOAT_EQ(cr3.orig().w,  1.f);

  EXPECT_NEAR(cr3.dir().x,  0.816f, float_err);
  EXPECT_NEAR(cr3.dir().y,  0.408f, float_err);
  EXPECT_NEAR(cr3.dir().z, -0.408f, float_err);
  EXPECT_NEAR(cr3.dir().w,  0.f,    float_err);
  ...
  EXPECT_FLOAT_EQ(cr4.orig().x,  0.f);
  EXPECT_FLOAT_EQ(cr4.orig().y,  0.f);
  EXPECT_FLOAT_EQ(cr4.orig().z,  0.f);
  EXPECT_FLOAT_EQ(cr4.orig().w,  1.f);

  EXPECT_NEAR(cr4.dir().x,  0.754f, float_err);
  EXPECT_NEAR(cr4.dir().y,  0.107f, float_err);
  EXPECT_NEAR(cr4.dir().z, -0.646f, float_err);
  EXPECT_NEAR(cr4.dir().w,  0.f, float_err);
}
